	...
	<form action="/searchCar">
		<select id="city" name="city">
		 ...
		 <label for="start">Start date:</label> 
		     <input type="date" id="start" name="startDt"/> 
		<label for="end">Start date:</label>
			 <input type="date" id="end" name="endDt"> <input type="submit" value="submit"/>
	</form>
		...
		<table border="1">
			...
			<c:forEach items="${api1}" var="element">
				<tr>
					...
					<td><a
						href="http://localhost:8000/bookcar?carId=${element.carId}">BOOK</a></td>
				</tr>
